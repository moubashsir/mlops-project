...
def test_split_data():
    ...
    """
    input_df = prefect_tasks.load_data.fn("https://storage.googleapis.com/mlflow-assignment-mj/training_data/day.csv")
...
def test_prepare_dictionaries():
    ...
    input_data = [(1, 0, 1, 0, 6, 0, 2, 0.344167, 0.363625, 0.805833, 0.160446)]

    input_columns = ["season", "yr", "mnth", "holiday", "weekday", "workingday", "weathersit", "temp", "atemp", "hum", "windspeed"]
